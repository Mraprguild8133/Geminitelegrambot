...
Made with ❤️ by {config.BOT_OWNER_NAME}
    ...
    async def admin_command(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        keyboard = [
            ...
            [InlineKeyboardButton("🌐 Web Dashboard", url=f"{config.WEB_DASHBOARD_URL if hasattr(config, 'WEB_DASHBOARD_URL') else '#'}")]
        ]
    ...
    async def run(self):
        ...
        logger.info(f"Starting bot by {config.BOT_OWNER_NAME} in polling mode")
